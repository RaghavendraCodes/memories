  ...
  return (
      <Form {...form}>
        <div className="sm:w-[420px] flex-center flex-col">
          ...
          <p className="text-light-3 small-medium md:base-regular mt-2"> to continue making more memories!.</p>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 xl:w-2/3 w-full mt-4">
        ...
        <p className="text-small-regular text-light-2 text-center mt-2">don't an account ?
